...
def cadastrar_tipo_equipamento(tipo_equipamento):
    tipo_equipamento_bd = tipo_equipamento_model.Tipo_equipamento(
        name=tipo_equipamento.name, description=tipo_equipamento.description)
...
def listar_tipo_equipamentosById(id):
    tipo_equipamento = tipo_equipamento_model.Tipo_equipamento.query.filter_by(
        id=id).first()
