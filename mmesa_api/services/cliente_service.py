...
def cadastrar_cliente(cliente):
    cliente_bd = cliente_model.Cliente(name=cliente.name, email=cliente.email, cell_contact=cliente.cell_contact,
                                       street_address=cliente.street_address, city_address=cliente.city_address, state_address=cliente.state_address)
