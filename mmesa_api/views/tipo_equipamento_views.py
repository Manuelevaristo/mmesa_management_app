...
class Tipo_equipamentoList(Resource):
    ...
    def post(self):
        ...
        if validate:
            ...
            novo_tipo_equipamento = tipo_equipamento.Tipo_equipamento(name=name, description=description)
            resultado = tipo_equipamento_service.cadastrar_tipo_equipamento(novo_tipo_equipamento)
...
class Tipo_equipamentoDetail(Resource):
    def get(self, id):
        tipo_equipamento = tipo_equipamento_service.listar_tipo_equipamentosById(id)
    ...
    def put(self, id):
        tipo_equipamento_bd = tipo_equipamento_service.listar_tipo_equipamentosById(id)
        ...
        if validate:
            ...
            novo_tipo_equipamento = tipo_equipamento.Tipo_equipamento(name=name, description=description)
            tipo_equipamento_service.actualiza_tipo_equipamento(tipo_equipamento_bd, novo_tipo_equipamento)
            tipo_equipamento_atualizado = tipo_equipamento_service.listar_tipo_equipamentosById(id)
